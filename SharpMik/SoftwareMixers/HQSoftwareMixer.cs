...
namespace SharpMik.SoftwareMixers
{
	...
	{
		static readonly int MAXVOL_FACTOR = (1 << 9);

		static readonly int SAMPLING_SHIFT = 2;
		static readonly uint SAMPLING_FACTOR = (uint)(1 << SAMPLING_SHIFT);

		static readonly int FRACBITS = 28;
		static readonly int FRACMASK = ((1 << FRACBITS) - 1);

		static readonly int TICKWSIZE = (TICKLSIZE * 2);
		static readonly int TICKBSIZE = (TICKWSIZE * 2);

		static readonly int CLICK_SHIFT_BASE = 6;
