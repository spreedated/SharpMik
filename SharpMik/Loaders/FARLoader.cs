...
namespace SharpMik.Loaders
{
    ...
    public class FARLoader : IModLoader
    {
        ...
        static readonly String FAR_Version = "Farandole";
        static FARHEADER1 mh1 = null;
        static FARHEADER2 mh2 = null;
        static FARNOTE[] pat = null;

        static readonly char[] FARSIG = { 'F', 'A', 'R', (char)0xfe, (char)13, (char)10, (char)26 };
        static readonly String FARSig1 = "FAR";
        static readonly String FARSig2 = new String(new char[] { (char)13, (char)10, (char)26 });
